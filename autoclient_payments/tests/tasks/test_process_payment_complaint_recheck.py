...
from autoclient_payments.tasks import process_payment_complaint_recheck
...
class TestHandlerCase(unittest.TestCase):
    ...
    def test_handle_429_response(self):
        ...
        process_payment_complaint_recheck.retry.assert_called_once_with(countdown=ret_aft)
    ...
    def test_handle_500_response(self):
        ...
        process_payment_complaint_recheck.retry.assert_called_once_with(countdown=DEFAULT_RETRY_AFTER)
