...
PAYMENT_COUNTERPARTY_SCHEME_ITEM = {
    "type": "object",
    "title": "Контрагент",
    "path": "payment.AUT_CNTR_ACC",
    "method": lambda x: next(
        (counterparty for counterparty, accounts in COUNTERPARTIES.items() if x in accounts), OTHER_COUNTERPARTIES
    ),
    "default": "",
}
...
PAYMENT_TYPE_SCHEME_ITEM = {
    "type": "object",
    "title": "Тип операції",
    "path": "payment.TRANTYPE",
    "method": lambda x: TransactionType(x).name,
    "default": "",
}
...
PAYMENT_SCHEME = {
    ...
    "source": PAYMENT_COUNTERPARTY_SCHEME_ITEM,
