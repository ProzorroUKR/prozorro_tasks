...
LIQPAY_PAYMENT_PROCESSING_ENABLED = bool(os.environ.get("LIQPAY_PAYMENT_PROCESSING_ENABLED", ""))
AUTOCLIENT_PAYMENT_PROCESSING_ENABLED = bool(os.environ.get("AUTOCLIENT_PAYMENT_PROCESSING_ENABLED", ""))
