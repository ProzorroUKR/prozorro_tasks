...
class ReceiptTestCase(unittest.TestCase):
    ...
    @patch("fiscal_bot.tasks.send_request_receipt.retry")
    @patch("fiscal_bot.tasks.requests")
    def test_prepare_request_error_status(self, requests_mock, retry_mock):
        retry_mock.side_effect = Retry
        filename = "test.xml"
        request_data = "Y29udGVudA=="
    ...
    @patch("fiscal_bot.tasks.requests")
    def test_prepare_request_error_response(self, requests_mock, save_sfs_data_mock, check_request_mock):
        filename = "test.xml"
        request_data = "Y29udGVudA=="
    ...
    @patch("fiscal_bot.tasks.prepare_check_request")
    @patch("fiscal_bot.tasks.decode_and_save_data")
    def test_prepare_request_success(self, decode_and_save_mock, prepare_check_request_mock):
        filename = "test.xml"
