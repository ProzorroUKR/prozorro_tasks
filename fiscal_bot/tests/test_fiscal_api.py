...
class ReceiptTestCase(unittest.TestCase):
    ...
    def test_template_built(self, get_increment_id_mock):
        ...
        get_increment_id_mock.assert_called_once()
        self.assertEqual(filename, "2659" "00AA426097" "J1603101" "1" "00" "0000001" "1" "12" "2017" "2659.xml")

        self.assertIn(b"<HNUM>1</HNUM>", content)
