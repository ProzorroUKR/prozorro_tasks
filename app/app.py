...
from autoclient_payments.views.views import bp as autoclient_payments_views_bp
...
app.register_blueprint(autoclient_payments_views_bp, url_prefix="/autoclient_payments")
